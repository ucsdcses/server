...
!function(a,b){
  ...
  var d,e,f=0,h=[];if (w(a)) for (d=a.length;d>f;f++)e=b(a[f],f,c),null!=e&&h.push(e);else for (f in a)e=b(a[f],f,c),null!=e&&h.push(e);return g.apply([],h);
  ...
  var b=!!a&&'length'in a&&a.length,c=r.type(a);return 'function'===c||r.isWindow(a)?!1:'array'===c||0===b||'number'==typeof b&&b>0&&b-1 in a; 
} var x=function(a){
  ...
  var d;return c?void 0:a[b]===!0?b.toLowerCase():(d=a.getAttributeNode(b))&&d.specified?d.value:null;
    ...
    return !!D(this,'string'==typeof a&&A.test(a)?r(a):a||[],!1).length;
      ...
      var c,d=0,e=this.length,f=[],g='string'!=typeof a&&r(a);if (!A.test(a)) for (;e>d;d++) for (c=this[d];c&&c!==b;c=c.parentNode) if (c.nodeType<11&&(g?g.index(c)>-1:1===c.nodeType&&r.find.matchesSelector(c,a))){
        f.push(c);break;
  ...
  var d,e,f,g,h=a.cloneNode(!0),i=r.contains(a.ownerDocument,a);if (!(o.noCloneChecked||1!==a.nodeType&&11!==a.nodeType||r.isXMLDoc(a))) for (g=la(h),f=la(a),d=0,e=f.length;e>d;d++)Ga(f[d],g[d]);if (b) if (c) for (f=f||la(a),g=g||la(h),d=0,e=f.length;e>d;d++)Fa(f[d],g[d]);else Fa(a,h);return g=la(h,'script'),g.length>0&&ma(g,!i&&la(a,'script')),h;
  ...
  r.fn[a]=function(a){
    ...
    for (var f=c===(d?'border':'content')?4:'width'===b?1:0,g=0;4>f;f+=2)'margin'===c&&(g+=r.css(a,c+aa[f],!0,e)),d?('content'===c&&(g-=r.css(a,'padding'+aa[f],!0,e)),'margin'!==c&&(g-=r.css(a,'border'+aa[f]+'Width',!0,e))):(g+=r.css(a,'padding'+aa[f],!0,e),'padding'!==c&&(g+=r.css(a,'border'+aa[f]+'Width',!0,e)));return g;
      ...
      var d,e=!0,f=La(a),g='border-box'===r.css(a,'boxSizing',!1,f);if (a.getClientRects().length&&(d=a.getBoundingClientRect()[b]),0>=d||null==d){
    ...
    var c,d=0,e={height:a};for (b=b?1:0;4>d;d+=2-b)c=aa[d],e['margin'+c]=e['padding'+c]=a;return b&&(e.opacity=e.width=a),e;
  } function db(a,b,c){
  ...
  return a!==!1&&(a=a||'fx'),this.each(function(){
    var b,c=V.get(this),d=c[a+'queue'],e=c[a+'queueHooks'],f=r.timers,g=d?d.length:0;for (c.finish=!0,r.queue(this,a,[]),e&&e.stop&&e.stop.call(this,!0),b=f.length;b--;)f[b].elem===this&&f[b].queue===a&&(f[b].anim.stop(!0),f.splice(b,1));for (b=0;g>b;b++)d[b]&&d[b].finish&&d[b].finish.call(this);delete c.finish;
  }); 
  ...
  'object'==typeof b&&(c=b,b=void 0),c=c||{};var e,f,g,h,i,j,k,l,m,n,o=r.ajaxSetup({},c),p=o.context||o,q=o.context&&(p.nodeType||p.jquery)?r(p):r.event,s=r.Deferred(),t=r.Callbacks('once memory'),u=o.statusCode||{},v={},w={},x='canceled',y={readyState:0,getResponseHeader:function(a){
    ...
    var j,m,n,v,w,x=c;k||(k=!0,i&&a.clearTimeout(i),e=void 0,g=h||'',y.readyState=b>0?4:0,j=b>=200&&300>b||304===b,d&&(v=Mb(o,y,d)),v=Nb(o,v,y,j),j?(o.ifModified&&(w=y.getResponseHeader('Last-Modified'),w&&(r.lastModified[f]=w),w=y.getResponseHeader('etag'),w&&(r.etag[f]=w)),204===b||'HEAD'===o.type?x='nocontent':304===b?x='notmodified':(x=v.state,m=v.data,n=v.error,j=!n)):(n=x,!b&&x||(x='error',0>b&&(b=0))),y.status=b,y.statusText=(c||x)+'',j?s.resolveWith(p,[m,x,y]):s.rejectWith(p,[y,x,n]),y.statusCode(u),u=void 0,l&&q.trigger(j?'ajaxSuccess':'ajaxError',[y,o,j?m:n]),t.fireWith(p,[y,x]),l&&(q.trigger('ajaxComplete',[y,o]),--r.active||r.event.trigger('ajaxStop'))); 
  } return y; 
