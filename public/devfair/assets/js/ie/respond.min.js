  ...
  'use strict';function b(){
    v(!0);
      ...
      var h,i,j,k=a.document,l=k.documentElement,m=[],n=[],o=[],p={},q=30,r=k.getElementsByTagName('head')[0]||l,s=k.getElementsByTagName('base')[0],t=r.getElementsByTagName('link'),u=function(){
          ...
          var c='clientWidth',d=l[c],e='CSS1Compat'===k.compatMode&&d||k.body[c]||d,f={},g=t[t.length-1],p=(new Date).getTime();if (b&&h&&q>p-h) return a.clearTimeout(i),i=a.setTimeout(v,q),void 0;h=p;for (var s in m) if (m.hasOwnProperty(s)){
